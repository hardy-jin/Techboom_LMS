<template>
  <div class="tinymce-box">
    <Editor :inline="inline" v-model="contentValue" :init="initOptions" :disabled="disabled" @onClick="onClick" />
  </div>
</template>
...
export default defineComponent({
  ...
  props: {
    ...
    plugins: {
      type: [String, Array],
      default:
        'preview searchreplace autolink directionality emoticons visualblocks visualchars fullscreen image link media template code codesample table charmap  pagebreak nonbreaking anchor insertdatetime advlist lists wordcount autosave ',
    },
    toolbar: {
      type: [String, Array],
      default:
